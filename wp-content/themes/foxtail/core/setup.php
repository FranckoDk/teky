 ...
 */
add_action('init', 'foxtail_create_custom_taxonomies', 0);
add_action('init', 'foxtail_create_custom_post_types', 0);
...
function foxtail_create_custom_post_types()
{
    register_post_type( 'course', array(
        'labels' => array(
            'name' => __( 'Courses', 'foxtail' ), // Tên post type dạng số nhiều
            'singular_name' => __( 'Course', 'foxtail' ) // Tên post type dạng số ít
        ),
        'description' => __( 'Course', 'foxtail' ), // Mô tả của post type
        'supports' => array(
            'title',
            'editor',
            'thumbnail'
...
//
//    register_sidebar(array(
//        'name' => __('Sidebar Showroom', 'foxtail'),
//        'id' => 'sidebar-showroom',
//        'description' => '',
//        'before_widget' => '',
//        'after_widget' => '',

...
function foxtail_pagination() {
    ...
    if ( $wp_query->max_num_pages > 1 ) : ?>
        ...
        <div class="pagination">
            ...
            <?php
            if ( get_previous_posts_link() ) echo '<li class="archive-nav-newer">' . get_previous_posts_link( '&larr; ' . __('Previous', 'foxtail')) . '</li>';
            ...
            if ( get_next_posts_link() ) echo '<li class="archive-nav-older">' . get_next_posts_link( __('Next', 'foxtail') . ' &rarr;') . '</li>';
            ?>
